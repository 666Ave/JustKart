<?php
    ...
    $insert_product_old = "insert into products (product_cat,product_brand,product_title,product_price,shop_id,product_descrp,product_image,time_added,product_keywords) values ('$product_cat','$product_brand','$product_title','$product_price','$shop_id','$product_desc','$product_image','$time_added','$product_keywords')";
