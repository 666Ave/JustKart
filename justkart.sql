...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2016 at 11:13 AM
...
(3, 2, 5, 'DELL XPS 13 ', 127000, 'Intel Core i7 (5th Gen)8 GB DDR3 RAM256 GB SSD', 'dell xps.jpg', 'Dell laptops, XPS 13, 4k'),
(4, 2, 6, 'HP Spectre 13-4013TU x360', 124999, 'Intel Core i7 (5th Gen)8 GB DDR3 RAM256 GB SSD Windows 8.1', 'hp ultrabook.jpg', 'HP laptops, Spectre 13 x360, 1440p'),
(5, 1, 7, 'Sony KLV-40R562C 101.6 cm (40) Full HD Internet LED Television', 48299, ' Type : LED - Display Resolution : 1920 x 1080 - Connectivity : 2 X HDMI & 2 X USB - Warranty : 1 Year Sony India Warranty - Screen Size : 101.6 cm (40) ', 'Sony KLV 40R562C.jpg', 'Sony TV , 1080p'),
(6, 1, 8, 'Onida 1.0 Ton 3 Star W123TRD Trendy Plus Window Air Conditioner', 22631, ' - 100 % Original Product with Brand Warranty | 1+5 Years Warranty - NO-HASSLES INSTALLATION SUPPORT ! We give you an Installation Helpline upon Delivery for a seamless, quick installation. - Auto Air Swing - Turbo Cleane-Saver - Sleep Mode ', 'Onida 1 Ton.jpg', 'Onida AC , 1 TON'),
(7, 4, 9, 'Aqua 18 Ltr Aqua Supreme Ro+uv+uf+tds Water Purifiers', 3850, ' - Stage Purification Process : 5 - Electricity Required : Yes - Capacity : 5-15 Ltr - Auto Shut Off : Yes - Type : RO ', 'Aqua 18Ltr.jpg', 'Aqua purifier, 18 Ltr'),
