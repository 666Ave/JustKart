...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2016 at 02:01 PM
...
(10, 10, 12, 'Kamachi 6 in 1 Manual Treadmill', 15995, ' Training for the game of life - This is a heavy product and might take longer than usual to get delivered ~ Compact & foldable ~ Product Type: Manual Treadmill ~ Easy to store ', 'Kamachi-6-in-1.jpg', 2, '2016-02-23 06:53:31', NULL, 'Kamachi , Manual Treadmill'),
(11, 3, 2, 'Samsung S6 32 GB', 400000, '  1 year brand warranty~ 12.95 cm (5.1) Full HD Super AMOLED Display~ Quad-core 1.5 GHz Cortex-A53 & Quad-core 2.1 GHz Cortex-A57 Processor~ 32 GB ROM / 3 GB RAM~ 16 MP Rear / 5 MP Front~ Android OS, v5.0.2 Lollipop~ Non-removable Li-Ion 2550 mAh battery~ Barometer, heart rate, SpO2 Senor~ SUPC: SDL634417341~ ', 'S6.jpg', 1, '2016-03-31 22:13:31', '2016-01-20', 'samsung,android,S6 ');
...
(4, 1, 'Testing', 2, 'It works bc!', '2016-03-31 21:11:42', 1),
(5, 1, 'Hey', 2, 'It works bc', '2016-03-31 21:13:34', 3);
...
INSERT INTO `user` (`User_ID`, `UName`, `Email_address`, `Password`, `shop_id`, `Mobile_no`, `Address`, `Pin_code`, `Purchases`, `fName`, `lName`, `Gender`, `Active`) VALUES
(1, 'root', '', 'a123456', NULL, '2147483647', '4/A, Old Barampur, Near st.Michael Church , Vasai (W) ', 123456, '', 'Admin', '', 'Male', 1),
(2, 'Ave', 'avian@gmail.com', 'admin6', 1, '7875089271', 'Kiravli , Papdi, Vasai(W)', 401202, '', 'Ave', 'Silvi', 'Male', 0);
